...
<html lang="en">
  ...
  <body>
	...
	<div class="container-fluid lxui-docs-container">
	 	<div class="row show-grid">
	 		...
	 		<div class="span-col10 border-left-1 show-grid">
				...
				<div class="row">
					<div class="span3 pull-right"><button type="button" class="btn btn-success">完成</button></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="${basepath}/assets/js/include_blood.js"></script>
  </body>
</html>