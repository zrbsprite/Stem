...
<html lang="en">
  ...
  <body>
	...
	<div class="container-fluid lxui-docs-container">
	 	<div class="row show-grid">
	 		...
	 		<div class="span-col10 border-left-1 show-grid">
	 			...
	 			<div class="row">
	 				<form action="${basepath}/archives/saveheart.htm" method="post" id="mainForm">
	...
	<script type="text/javascript" src="${basepath}/assets/js/include_heart.js"></script>
  </body>
</html>