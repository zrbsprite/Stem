...
<html lang="en">
  ...
  <#assign menu_name='menu_crowsquery'>
	...
	<div class="container-fluid lxui-docs-container">
	 	<div class="row show-grid">
	 		...
	 		<div class="span-col10 border-left-1 show-grid">
	 			...
	 			<form action="${basepath}/archives/savels.htm" method="post" id="mainForm">
	 			<div class="row">
	...
	<script type="text/javascript" src="${basepath}/assets/js/include_lifestyle.js"></script>
  </body>
</html>