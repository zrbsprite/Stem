<div class="container-fluid">
	...
	<div class="row">
		<div class="span12">
              ...
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[0].brothersister" <#if zr_brain.brothersister?exists && zr_brain.brothersister==1>checked</#if>>兄弟姐妹（患病
              </label>
              <label class="checkbox-inline">
              	 <input type="number" value="${zr_brain.brothersisterNo}" name="arrays[0].brothersisterNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;">
              </label>
              <label class="checkbox-inline">
              	 人）
              </label>
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[0].children" <#if zr_brain.children?exists && zr_brain.children==1>checked</#if>>子女（患病
              </label>
              <label class="checkbox-inline">
              	 <input type="number" value="${zr_brain.childrenNo}" name="arrays[0].childrenNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;">
              </label>
              <label class="checkbox-inline">
              	 人）
              </label>
	...
	<div class="row">
		<div class="span12">
              ...
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[1].brothersister" <#if zr_diabetes.brothersister?exists && zr_diabetes.brothersister==1>checked</#if>>兄弟姐妹（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_diabetes.brothersisterNo}" name="arrays[1].brothersisterNo" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[1].children" <#if zr_diabetes.children?exists && zr_diabetes.children==1>checked</#if>>子女（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_diabetes.childrenNo}" name="arrays[1].childrenNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
	...
	<div class="row">
		<div class="span12">
              ...
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[2].brothersister" <#if zr_dyslipidemia.brothersister?exists && zr_dyslipidemia.brothersister==1>checked</#if>>兄弟姐妹（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${childrenNo.brothersisterNo}" name="arrays[2].brothersisterNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[2].children" <#if zr_dyslipidemia.children?exists && zr_dyslipidemia.children==1>checked</#if>>子女（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_dyslipidemia.childrenNo}" name="arrays[2].childrenNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
	...
	<div class="row">
		<div class="span12">
              ...
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[3].brothersister" <#if zr_heart.brothersister?exists && zr_heart.brothersister==1>checked</#if>>兄弟姐妹（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_heart.brothersisterNo}" name="arrays[3].brothersisterNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[3].children" <#if zr_heart.children?exists && zr_heart.children==1>checked</#if>>子女（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_heart.childrenNo}" name="arrays[3].childrenNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
	...
	<div class="row">
		<div class="span12">
              ...
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[4].brothersister" <#if zr_highblood.brothersister?exists && zr_highblood.brothersister==1>checked</#if>>兄弟姐妹（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_highblood.brothersisterNo}" name="arrays[4].brothersisterNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
              <label class="checkbox-inline">
              	 <input type="checkbox" value="1" name="arrays[4].children" <#if zr_highblood.children?exists && zr_highblood.children==1>checked</#if>>子女（患病
              </label>
              <label class="checkbox-inline">
              	<input type="number" value="${zr_highblood.childrenNo}" name="arrays[4].childrenNo" maxlength="2" class="form-control" style="width:50px;margin-left:-20px;margin-right:-20px;" maxlength="2">
              </label>
              <label class="checkbox-inline">
           		    人）
              </label>
