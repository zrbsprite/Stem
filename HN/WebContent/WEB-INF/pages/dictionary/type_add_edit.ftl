...
<html lang="en">
  ...
  <body>
	 			...
	 			<div class="row">
	 				<div class="container-fluid">
			 			<div class="panel panel-default">
		  					...
		  					<#-- start -->
		  					<form class="form-horizontal" role="form" action="${basepath}/sys/dic/type/s.htm" method="post">
							  <div class="form-group">
							    <label for="input_role_desc" class="span3 control-label">类型编码</label>
							    <div class="span8">
							      <input type="text" class="form-control" id="input_type_codeid" name="codeid" value="${bean.codeid}" <#if bean.codeid?exists>readonly</#if> placeholder="请输入类型编码" maxlength="50">
							    </div>
							  </div>
							  <div class="form-group">
							    <label for="input_role_auth" class="span3 control-label">类型详情</label>
							    <div class="span8">
							  ...
							  <div class="form-group">
							    ...
							    <div class="span8">
							      <input type="number" class="form-control" id="input_type_length" name="cptr" value="${bean.length}" placeholder="请输入限制长度" maxlength="3">
							    </div>
							  </div>
	...
	<script type="text/javascript" src="${basepath}/assets/js/dic/include_typeadd.js"></script>
  </body>
</html>