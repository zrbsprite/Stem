...
<article class="wrapper">
	<div class="score">
        <h1>和谐宝贝健康成长计划</h1>
        <p>和谐宝贝健康险涵盖投资、护理、意外、重疾、医疗、住院津贴等多项功能,全面呵护孩子健康成长！</p>
    </div>
    <ul class="proShareUl">
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">投资、保障两不误，全面呵护孩子健康成长！</p>
                <div class="k clearfix"><img src="${imageUrl}/banner_11.jpg" /><span>和谐宝贝健康险涵盖投资、护理、意外、重疾、医疗、住院津贴等多项功能,全面呵护孩子健康成长！</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">有孩子的父母看看,可保20种重大疾病,年交投入无负担,满期领取,规划孩子的美好人生！ </p>
                <div class="k clearfix"><img src="${imageUrl}/banner_11.jpg" /><span>和谐宝贝健康险涵盖投资、护理、意外、重疾、医疗、住院津贴等多项功能,全面呵护孩子健康成长！</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">选择投保和谐宝贝健康成长计划保险,是辣妈爱孩子最明智的选择！</p>
	                <div class="k clearfix"><img src="${imageUrl}/banner_11.jpg" /><span>和谐宝贝健康险涵盖投资、护理、意外、重疾、医疗、住院津贴等多项功能,全面呵护孩子健康成长！</span></div>
            </div>
        </li>
    </ul>
    <a href="${ctx}/wx/product/datil.htm?productId=${productId}&kuser=${kuser}" class="btn blueBtn">我要分享和谐宝贝</a>
</article>
