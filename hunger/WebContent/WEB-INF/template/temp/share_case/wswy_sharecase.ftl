...
<article class="wrapper">
	<div class="score">
        <h1>万事无忧交通意外险</h1>
        <p>小伙伴们,万事无忧DIY交通意外险的分享案例已经帮您准备好了，您再也不用搜肠刮肚去想那些宣传文案了，长按即可复制哦。</p>
    </div>
    <ul class="proShareUl">
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">史上最贴心的交通意外险，没有之一！真正万事无忧！</p>
                <div class="k clearfix"><img src="${imageUrl}/wswy_banner_mini.jpg" /><span>12种交通工具、500万高额身价、1~365天，任意自由DIY。</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">万事无忧交通意外险，抽到几折打几折，中奖率高达百分百！ </p>
                <div class="k clearfix"><img src="${imageUrl}/wswy_banner_mini.jpg" /><span>12种交通工具、500万高额身价、1~365天，任意自由DIY。</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">真正按需购买，绝不打包强卖，最低0.5元起！居家旅行，出差访友，出行必备！</p>
	                <div class="k clearfix"><img src="${imageUrl}/wswy_banner_mini.jpg" /><span>12种交通工具、500万高额身价、1~365天，任意自由DIY。</span></div>
            </div>
        </li>
    </ul>
    <a href="${ctx}/wx/product/datil.htm?productId=${productId}&kuser=${kuser}" class="btn blueBtn">我要分享万事无忧</a>
</article>
