    ...
    <ul class="proShareUl">
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">35天短期投资很不错哦，不用长时间占资金。</p>
                <div class="k clearfix"><img src="${request.getContextPath()}/assets/wxdgid/products/re1/share_2.jpg" /><span>35天的理财产品，预期年化收益率4.90%万！</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <div class="k clearfix"><img src="${request.getContextPath()}/assets/wxdgid/products/re1/share_2.jpg" /><span>35天的理财产品，预期年化收益率4.90%！</span></div>
            </div>
        </li>
    </ul>
    <a href="${ctx}/wx/product/datil.htm?productId=${productId}&kuser=${kuser}" style="background-color:#ff6801;" class="btn blueBtn">我要分享 蓉e一号</a>
</article>
