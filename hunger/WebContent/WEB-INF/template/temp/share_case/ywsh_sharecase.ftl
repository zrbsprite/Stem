...
<article class="wrapper">
	<div class="score">
        <h1>邦安无忧综合老年意外险</h1>
        <p>小伙伴们，邦安无忧综合老年意外险的分享案例已经帮您准备好了，您再也不用搜肠刮肚去想那些宣传文案了，长按即可复制哦。</p>
    </div>
    <ul class="proShareUl">
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">有一种幸福叫上有老，有一道风景是回家的路。</p>
                <div class="k clearfix"><img src="${imageUrl}/top_banner01.jpg" /><span>有一种幸福叫上有老，有一道风景是回家的路。</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">最幸福的事：我已长大，你还在我身边。 </p>
                <div class="k clearfix"><img src="${imageUrl}/top_banner01.jpg" /><span>最幸福的事：我已长大，你还在我身边。</span></div>
            </div>
        </li>
        <li>
            ...
            <div class="r">
                ...
                <p class="l2">父母已老，请紧握住他们的手，陪他们慢慢的走。</p>
	                <div class="k clearfix"><img src="${imageUrl}/top_banner01.jpg" /><span>父母已老，请紧握住他们的手，陪他们慢慢的走。</span></div>
            </div>
        </li>
    </ul>
    <a href="${ctx}/wx/product/datil.htm?productId=${productId}&kuser=${kuser}" class="btn blueBtn">我要分享邦安无忧综合老年意外险</a>
</article>
