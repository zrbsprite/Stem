...
<head> 
    ...
    <title>火爆热销，康赢5号健康投资两不误！</title> 
    <link href="${cssUrl}/cards_ky5.css?v=201407311741" type="text/css" rel="stylesheet" />
...
<script>
	...
	<header style=" line-height:0; height:0;">
        <audio autoplay="autoplay" loop id="audiomusic">
          <source src="${productsimageUrl}/ky5/HappySong.mp3" type="audio/mpeg" />
        </audio>
	...
	<div class="wrapper" id="wrap" style="display:none">
    	<section class="page">
        	<div class="card">
                <div class="title">理财与保障如何兼顾？</div>
                <div class="couple android_2_3_x">
                    <div class="ico_01"></div>
                    <div class="ico_02"></div>
                    <div class="ico_03"></div>
                    <div class="ico_04"></div>
                </div>
                <div class="btitle">如果有这样一种保险产品</div>
            </div>
            <div class="start"></div>
        </section>
        <section class="page">
        	<div class="card" style="display:none;">
            	<div class="slogan">日计息，月复利，财富稳步递增</div>
            	<div class="arr_1"></div>
                <div class="txt_1"></div>
                <div class="arr_2"></div>
                <div class="txt_2"></div>
        ...
        <section class="page">
        	<div class="card" style="display:none;">
            	...
            	<div class="couple android_2_3_x"></div>
                <i class="ico_3"></i><i class="ico_2"></i><i class="ico_1"></i>
            </div>
        	<div class="start"></div>
        </section>
        <section class="page">
...
<!--<script type="text/javascript" src="http://static.paipaiimg.com/wx/js/halo.js"></script>-->
...
var kuser;
kuser = Request['kuser'];
var btnky5=document.getElementById("btnky5");
halo.use('pageinvite','pagedrag','warn',function(m){
    m.on(btnky5,'flick',function(){
        location.href = "http://w.ab95569.com/wx/product/datil.htm?productId=${productId!""}&kuser=${kuser!""}";
    },false);
});
</script>
...
<script type="text/javascript">
var shareTitle = '健康保障+长期理财=实现未来所需';
var shareTxt = '每一万元送50元京东E卡，让你想买什么买什么。';
var sharePic ;
var host_Name=location.hostname;
if(host_Name != null && ( host_Name == 'w.ab95569.com' || host_Name == 'www.ab95569.com' )){
    sharePic = 'http://w.ab95569.com/assets/wxdgid/products/ky5/s_1.jpg';
}else{
	sharePic = 'http://36.ab95569.com/assets/wxdgid/products/ky5/s_1.jpg';
}
