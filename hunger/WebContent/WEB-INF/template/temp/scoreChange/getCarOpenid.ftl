...
$(function(){
	...
	if(appid!=null&&appid!=''&&redirect_uri!=null&&redirect_uri!=''&&state!=null&&state!=''){
		window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + appid + "&redirect_uri=" + redirect_uri + "&response_type=code&scope=snsapi_base&state=" + state  + url_hostname +"|"+ "#wechat_redirect" ;
	}
}); 
</script>
</body>
