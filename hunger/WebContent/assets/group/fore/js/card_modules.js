...
halo.use(function(m){
	halo.add('loadimg',function(images,parent,bg,cb){//加载图片
		...
		if(arguments.length==2){
			...
			cb=bg;
			typeof(parent)=='string'&&(bg=parent);
		...
		_wrp.style.cssText='position:absolute; left:0; top:0; right:0; bottom:0; background-color:'+bg+'; z-index:9;',box.style.cssText='position:absolute; width:150px; height:150px; border-radius:2px; background-color:rgba(0,0,0,0); color:rgba(255,255,255,.8); margin:-75px 0 0 -75px; left:50%; top:50%;',circle.style.cssText='position:absolute; width:60px; height:60px; left:50%; top:50%; margin:-30px 0 0 -30px; '+webkit+'animation:loading 1.2s linear infinite;',loading_bar.style.cssText='width:54px; height:54px; border:3px solid rgba(255,255,255,.8); border-radius:30px; clip:rect(0px,30px,60px,0); position:absolute; left:0; top:0; '+webkit+'transform-origin:center; -webkit-background-origin:border-box; -webkit-background-clip:border-box; -webkit-mask:-webkit-gradient(linear,0 0,0 100%,from(rgba(255,255,255,1)),to(rgba(255,255,255,0))); opacity:.99;',p.style.cssText='margin:0; padding:0; text-align:center; width:100%; position:absolute; bottom:10px; left:0; font-size:20px; font-weight:bold; line-height:18px; white-space:nowrap';
...
halo.use(function(m){
	...
	var warn=function(){
		...
		var set=function(bg,icon,text){
			//设置warn的样式
			if(typeof(bg)=='string')_warn_wrp.style.backgroundColor=bg;
	...
	halo.add('warn',warn);
})/*  |xGv00|26826a603472c954f8c2da14b1d01ecf */